...
> Show artifact-derived harness state (tier, ledger, step, validation freshness, critic state). Use when starting work, when asked what the agent is doing, or to verify alignment claims.
