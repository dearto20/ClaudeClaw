---
name: harness-ledger
description: Create, update, and close execution ledgers. Use before any non-trivial tracked edit (standard/high-risk tier), at every phase transition, and when finishing governed work.
---
