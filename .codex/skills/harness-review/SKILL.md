---
name: harness-review
description: Run independent critic review for non-trivial work — same-family critic by default, cross-family transport for high-risk work. Use before declaring planning, implementation, or completion ready.
---
